...
export declare function matchesRedirect(input: string[], route: RouteRedirect): route is RouteRedirect;
export declare function routeRedirect(path: string[], routes: RouteRedirect[]): RouteRedirect | undefined;
