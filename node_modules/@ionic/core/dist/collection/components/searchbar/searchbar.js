...
export class Searchbar {
     ...
     */
    onBlur() {
        const inputEl = (this.el.shadowRoot || this.el).querySelector('.searchbar-input');
    ...
    hostData() {
        return {
            class: Object.assign({}, createColorClasses(this.color), { 'searchbar-active': this.activated, 'searchbar-animated': this.animated, 'searchbar-has-value': (this.value !== ''), 'searchbar-show-cancel': this.showCancelButton, 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused })
        };
    }
    render() {
        ...
        const cancelButton = (this.showCancelButton)
            ? h("button", { type: "button", tabIndex: this.mode === 'ios' && !this.activated ? -1 : undefined, onClick: this.cancelSearchbar.bind(this), onMouseDown: this.cancelSearchbar.bind(this), class: "searchbar-cancel-button" }, this.mode === 'md'
                ? h("ion-icon", { mode: this.mode, icon: this.cancelButtonIcon })
                : this.cancelButtonText)
            : null;
        return [
            h("div", { class: "searchbar-input-container" },
                this.mode === 'md' && cancelButton,
                h("ion-icon", { mode: this.mode, icon: searchIcon, class: "searchbar-search-icon" }),
                ...
                h("button", { type: "button", class: "searchbar-clear-button", onClick: this.clearInput.bind(this), onMouseDown: this.clearInput.bind(this) },
                    h("ion-icon", { mode: this.mode, icon: clearIcon, class: "searchbar-clear-icon" }))),
