...
export class ActionSheet {
    ...
    hostData() {
        return {
            ...
            class: Object.assign({}, createColorClasses(this.color), getClassMap(this.cssClass), { 'action-sheet-translucent': this.translucent })
        };
    }
    render() {
                    ...
                    h("div", { class: "action-sheet-group" },
                        ...
                        buttons.map(b => h("button", { class: buttonClass(b), onClick: () => this.buttonClick(b) },
                            h("span", { class: "action-sheet-button-inner" },
                                b.icon
                                    ? h("ion-icon", { icon: b.icon, class: "action-sheet-icon" })
                                    : null,
                                b.text)))),
                    cancelButton
                        ? h("div", { class: "action-sheet-group action-sheet-group-cancel" },
                            h("button", { class: buttonClass(cancelButton), onClick: () => this.buttonClick(cancelButton) },
                                h("span", { class: "action-sheet-button-inner" },
                                    cancelButton.icon
                                        ? h("ion-icon", { icon: cancelButton.icon, class: "action-sheet-icon" })
                                        : null,
                                    cancelButton.text)))
                        : null))
        ];
