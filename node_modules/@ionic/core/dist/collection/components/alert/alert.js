...
export class Alert {
    ...
    callButtonHandler(button, data = undefined) {
    ...
    hostData() {
        return {
            ...
            class: Object.assign({}, createColorClasses(this.color), getClassMap(this.cssClass), { 'alert-translucent': this.translucent })
        };
    }
    renderAlertButtons() {
        ...
        return (h("div", { class: alertButtonGroupClass }, buttons.map(button => h("button", { class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) },
