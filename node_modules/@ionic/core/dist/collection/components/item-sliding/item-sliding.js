...
export class ItemSliding {
    ...
    render() {
        return (h("ion-gesture", { canStart: this.canStart.bind(this), onStart: this.onDragStart.bind(this), onMove: this.onDragMove.bind(this), onEnd: this.onDragEnd.bind(this), gestureName: 'item-swipe', gesturePriority: -10, direction: 'x', maxAngle: 20, threshold: 5, attachTo: 'parent' },
            h("slot", null)));
    }
