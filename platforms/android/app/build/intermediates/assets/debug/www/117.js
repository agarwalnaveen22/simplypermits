...
function enableScrollAssist(t, e, n, o) { var r; var i = function (t) { r = Object(_chunk_deb847e6_js__WEBPACK_IMPORTED_MODULE_0__["b"])(t), t.type; }, s = function (i) { if (i.type, !r)
    return; var s = Object(_chunk_deb847e6_js__WEBPACK_IMPORTED_MODULE_0__["b"])(i); hasPointerMoved(6, r, s) || isFocused(e) || (i.preventDefault(), i.stopPropagation(), jsSetFocus(t, e, n, o)); }; return t.addEventListener("touchstart", i, !0), t.addEventListener("touchend", s, !0), function () { t.removeEventListener("touchstart", i, !0), t.removeEventListener("touchend", s, !0); }; }
function jsSetFocus(t, e, n, o) { var r = getScrollData(t, n, o); Math.abs(r.scrollAmount) < 4 ? e.focus() : (relocateInput(t, e, !0, r.inputSafeY), e.focus(), n.getScrollElement().scrollByPoint(0, r.scrollAmount, r.scrollDuration, function () { relocateInput(t, e, !1, r.inputSafeY), e.focus(); })); }
